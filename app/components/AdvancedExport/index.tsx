/**
 * @fileoverview Advanced Export Component - Refactored Version
 * @author Senior Developer
 * @version 2.0.0
 * 
 * Komponen utama untuk export advanced dengan arsitektur yang sudah direfactor:
 * - Separation of concerns
 * - Custom hooks untuk business logic
 * - Sub-components untuk UI
 * - Utility functions untuk operasi data
...
export const AdvancedExport: React.FC<AdvancedExportProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={`flex flex-col p-0 mx-auto ${
        isMobile
        ...
        <div className={`flex-1 flex overflow-hidden min-h-0 ${
          ...
          <div className={`bg-muted/20 flex flex-col advanced-export-options-panel ${
            isMobile || isTablet
            ...
            <Tabs defaultValue="format" className={`h-full flex flex-col ${
              ...
              {/* Tabs Navigation */}
              <TabsList className={`grid z-20 flex-shrink-0 ${
                isMobile || isTablet
