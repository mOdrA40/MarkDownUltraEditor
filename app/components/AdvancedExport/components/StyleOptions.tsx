/**
 * @fileoverview Komponen untuk konfigurasi style dan theme
...
import { StyleOptionsProps, ThemeType, FontFamily, PageSize, PageOrientation } from '../types/export.types';
import { THEMES, FONT_FAMILIES, PAGE_SIZES, PAGE_ORIENTATIONS, FONT_SIZE_RANGE } from '../utils/constants';
  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      ...
      <div className="space-y-3">
        <div>
          <Label htmlFor="fontFamily" className={`${
        ...
        <div>
          <Label htmlFor="fontSize" className={`${
            isMobile ? 'text-xs' : 'text-xs sm:text-sm'
          }`}>
      ...
      <div className="space-y-3">
        ...
        <div>
          <Label htmlFor="orientation" className={`${
            isMobile ? 'text-xs' : 'text-xs sm:text-sm'
          }`}>
            Orientation
          </Label>
