/**
 * @fileoverview Komponen untuk preview panel dengan responsive controls
...
export const PreviewPanel: React.FC<PreviewPanelProps> = ({
  ...
  return (
    <div className="flex flex-col min-h-0 overflow-hidden flex-1">
      ...
      {/* Preview Content */}
      <div className={`advanced-export-preview-content overflow-y-auto ${
        isMobile ? 'p-2 min-h-[500px] max-h-[60vh]' : isTablet ? 'p-2 min-h-[450px] max-h-[65vh]' : 'p-2 sm:p-3'
      }`}>
        <div
          className={`
