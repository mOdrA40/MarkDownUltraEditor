/**
 * @fileoverview Komponen untuk memilih format export
...
export const FormatSelector: React.FC<FormatSelectorComponentProps> = ({
  ...
  return (
    <div className="space-y-3 sm:space-y-4">
            ...
            return (
              ...
              >
                <CardContent className={`text-center ${
                  ...
                  <Icon className={`mx-auto mb-1 text-blue-600 ${
      ...
      {/* Export Options */}
      <div className={`space-y-2 ${
        isMobile ? 'space-y-3' : 'sm:space-y-3'
      }`}>
        <div className="flex items-center space-x-2">
          <Checkbox
            id="toc"
            checked={options.includeTableOfContents}
            onCheckedChange={(checked) => onOptionsChange('includeTableOfContents', checked as boolean)}
            className={`${
              isMobile ? 'h-5 w-5' : 'h-4 w-4'
            }`}
          />
          <Label htmlFor="toc" className={`${
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="pageNumbers" className={`${
            isMobile ? 'text-sm' : 'text-xs sm:text-sm'
          }`}>
        ...
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="headerFooter" className={`${
            isMobile ? 'text-sm' : 'text-xs sm:text-sm'
          }`}>
