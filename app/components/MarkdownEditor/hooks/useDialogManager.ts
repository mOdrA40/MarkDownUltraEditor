...
export const useDialogManager = (): UseDialogManagerReturn => {
  ...
  /**
   * Show image manager dialog
   */
  const showImageManagerDialog = useCallback(() => {
    showDialog('showImageManager');
  }, [showDialog]);
  ...
  const closeImageManagerDialog = useCallback(() => hideDialog('showImageManager'), [hideDialog]);
