...
export const ResponsiveStatsLayout: React.FC<ResponsiveStatsLayoutProps> = memo(
  ({ children, screenSize, stats, className = '', layoutStyles = {} }) => {
    const breakpointConfig =
      BREAKPOINTS_STATS[screenSize === 'small-tablet' ? 'smallTablet' : screenSize];
          ...
          <div className={breakpointConfig.classes.statsLeft}>
            ...
            <div className="writing-stats-row">
              <div className="flex items-center gap-2 flex-wrap min-w-0">
                ...
                <div className={breakpointConfig.classes.separator} />
              ...
              <div className={breakpointConfig.classes.statsRight}>
                ...
                <StatBadge variant="outline">{documentStatus}</StatBadge>
              </div>
            </div>
