...
h1 {
  /* Custom heading styles */
          ...
          rows={isMobile ? 6 : 5}
          className={`font-mono resize-none ${isMobile ? 'text-xs' : 'text-xs sm:text-sm'}`}
        />
        <p className={`text-muted-foreground mt-1 ${isMobile ? 'text-xs' : 'text-xs'}`}>
      ...
      {/* CSS Helper Tips */}
      <div className={`bg-muted/50 rounded-lg p-3 ${isMobile ? 'text-xs' : 'text-xs'}`}>
        <h4 className="font-medium mb-2">💡 CSS Tips:</h4>
        <ul className="space-y-1 text-muted-foreground">
          <li>
            • Use <code className="bg-muted px-1 rounded">body</code> for global styling
          </li>
          <li>
            • Use <code className="bg-muted px-1 rounded">h1, h2, h3</code> for headings
          </li>
          <li>
            • Use <code className="bg-muted px-1 rounded">p</code> for paragraphs
          </li>
          <li>
            • Use <code className="bg-muted px-1 rounded">blockquote</code> for quotes
          </li>
          <li>
            • Use <code className="bg-muted px-1 rounded">code, pre</code> for code blocks
          </li>
        </ul>
      </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-yellow-700 dark:text-yellow-300 mt-1">
                Preview mungkin tidak menampilkan custom CSS dengan sempurna. Hasil akhir akan
                terlihat pada dokumen yang di-export.
              </p>
            </div>
          </div>
        </div>
