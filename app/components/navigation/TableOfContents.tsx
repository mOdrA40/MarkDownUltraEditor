 ...
 */
export const TableOfContents: React.FC<TableOfContentsProps> = ({ markdown, theme }) => {
  ...
  const { isActive, handleHeadingClick, totalItems } = useTocNavigation(
    tocItems,
    {
      offset: 100,
      threshold: 0.6,
  ...
  return (
    <div className="h-full flex flex-col" data-toc-container>
      {/* Header */}
      <TocHeader itemCount={totalItems} theme={theme} />
